          ...
          "@graph": [
              ...
              potentialAction: [
                {
                  ...
                  target: {
                    "@type": "EntryPoint",
                    urlTemplate:
                      "https://vishwajeetkondi.vercel.app/?s={search_term_string}",
                  },
            ...
            },
            {
              ...
              image: {
                ...
                inLanguage: "en-US",
                "@id":
                  "https://vishwajeetkondi.vercel.app/#/schema/person/image/",
                url: "https://vishwajeetkondi.vercel.app/profile_image.jpg",
                contentUrl:
                  "https://vishwajeetkondi.vercel.app/profile_image.jpg",
                width: 400,
                height: 400,
                caption: "Vishwajeet Kondi",
              },
              description:
                "Full Stack Software Developer specializing in React, Node.js, and modern web technologies",
              sameAs: [
